...
?>
        ...
        <nav class="filter_section2">
            ...
            <div id="alle" class="buttonContainer2">
                <button id="filterknap" class="gs valgt" data-kategori="alle">Alle tilbud</button>
            ...
            <div id="tema3" class="buttonContainer2">
                <button id="filterknap" class="gs" data-kategori="Demokrati og Medborgerskab">Demokrati og
        ...
        <div class="overskrift-container">
            <h3 id="overskrift" class="">Tilbud til grundskolen</h3>
